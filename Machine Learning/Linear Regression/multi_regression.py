...
class Multiple_Linear_Regression:
    ...
    def __init__(self, x_train, y_train, learning_rate, number_of_iterations, lambda_=1):
        ...
        self.cost, self.parameters, self.w_final, self.b_final = Multiple_Linear_Regression.gradient_descent(
    ...
    def gradient_descent(X, Y, w_init, b_init, learning_rate, iterations, lambda_):
        ...
        for i in range(iterations):
            ...
            dj_dw, dj_db = Multiple_Linear_Regression.gradient_function(
                X, Y, w, b, lambda_)
            ...
            cost_history.append(
                Multiple_Linear_Regression.cost_function(X, Y, w, b, lambda_))
